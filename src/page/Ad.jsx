...
const Ad = () => {
  return (
    <section className="relative mb-20 w-5/6 mx-auto">
      ...
      <div className="absolute text-center md:text-left md:right-[107px] w-[600px]  md:w-[430px] md:top-0 top-[500px] ">
        <p className="font-anybody text-[40px] mb-[40px] md:font-semibold font-bold text-white md:text-black">Complate your dazzling look with our collections</p>
